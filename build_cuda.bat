...
chcp 65001 >nul
REM ============================================
REM WebGenAI - CUDA Build Script (NVIDIA GPU 가속)
REM ============================================

echo.
echo ========================================
echo   WebGenAI Build (CUDA)
echo ========================================
echo.
...
if %errorlevel% neq 0 (
    echo [WARN] Pre-built CUDA wheel unavailable. Building from source...
...
echo ========================================
echo.
echo Executable: dist\WebGenAI-CUDA\WebGenAI-CUDA.exe
echo.
set /p RUN="Run now? (y/n) "
if /i "%RUN%"=="y" (
    echo.
    start "" dist\WebGenAI-CUDA\WebGenAI-CUDA.exe
)
